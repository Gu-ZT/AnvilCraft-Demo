package dev.anvilcraft.demo.data.fabric;
...
public class AnvilCraftDemoDatagen implements DataGeneratorEntrypoint {
    ...
    public void onInitializeDataGenerator(FabricDataGenerator fabricDataGenerator) {
        ...
        AnvilCraftDemo.REGISTRATE.setupDatagen(pack, helper);
    }
}
